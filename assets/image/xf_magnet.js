...
function onComplete(data) {
      ...
      for(var i=0;i<data.files.length;i++){ if(i%2="=0){" html+="<tr class="odd"><td><input type="checkbox" /></td><td><span class="choose_filename"  size="" +data.files[i].file_size_ori+'"="" index="'+data.files[i].file_index+'" title="'+data.files[i].file_name+'">'+QQXF.COMMON.getFileType(data.files[i].file_name,25)+'<td>'+data.files[i].file_size+'</td>'
          }else{
      ...
      html=html+'</data.files.length;i++){></table></div><dl><dt>选择:</dt><dd><a id="check_all" href="###">全选</a></dd><dd><a id="check_opposite" href="###">反选</a></dd><dd><a id="check_auto" href="###">智能</a></dd><dd class="choose_num_box">已选<b id="num_choosed">0</b>/<b id="num_allfiles">0</b>个</dd> <dd class="bt_size_opt"> 文件大小:<em id="bt_choose_space"></em></dd><dd class="bt_size_opt">剩余空间:<em id="bt_left_space"><em></em></em></dd></dl></div>';
